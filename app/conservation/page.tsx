      ...
      <div className="relative bg-ocean-gradient py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-ocean-100 max-w-3xl mx-auto leading-relaxed">
            Protecting the sea turtles and marine life of South Padre Island,
            Texas
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-20">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              At Shenna&apos;s Studio, we&apos;re passionate about protecting
              the incredible marine ecosystem that surrounds South Padre Island,
              especially the magnificent sea turtles that call our waters home.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 bg-white rounded-2xl shadow-lg border border-ocean-100">
              ...
              <p className="text-gray-600">
                Every sea turtle that nests on our beautiful beaches inspires
                our dedication to conservation efforts.
              </p>
            </div>
            ...
            <div className="text-center p-8 bg-white rounded-2xl shadow-lg border border-ocean-100">
              ...
              <p className="text-gray-600">
                10% of every purchase goes directly to ocean conservation
            ...
            <div className="text-center p-8 bg-white rounded-2xl shadow-lg border border-ocean-100">
              ...
              <p className="text-gray-600">
                Supporting research and protection programs that ensure sea
                turtles thrive for generations to come.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-ocean-100 text-lg mb-6 leading-relaxed">
                  Our home on South Padre Island places us at the heart of one
                  of Texas&apos;s most important sea turtle nesting areas. Every
                  year, we witness the miracle of Kemp&apos;s ridley,
                  loggerhead, and green sea turtles returning to our shores to
                  nest.
                </p>
                <p className="text-ocean-100 text-lg leading-relaxed">
                  This incredible natural phenomenon drives our passion for
                  conservation and reminds us daily why protecting our oceans is
                  so crucial.
                </p>
              </div>
              <div className="bg-white/10 rounded-2xl p-8 backdrop-blur-sm">
                <h3 className="text-2xl font-bold mb-6">
                  Sea Turtle Species We Protect
                </h3>
        ...
        <section className="mb-20">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Every purchase you make helps fund critical conservation efforts
              and research programs dedicated to protecting sea turtles and
              marine ecosystems.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-md border border-ocean-100">
              ...
              <p className="text-gray-600 text-sm">
                Goes directly to ocean conservation organizations
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-ocean-100">
              ...
              <p className="text-gray-600 text-sm">
                Supporting turtle patrol and nesting site protection
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-ocean-100">
              ...
              <p className="text-gray-600 text-sm">
                Funding rescue and rehabilitation programs
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-ocean-100">
              ...
              <p className="text-gray-600 text-sm">
                Ensuring sea turtles thrive for years to come
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-20">
          <div className="bg-ocean-50 rounded-3xl p-12">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We work alongside dedicated organizations committed to sea
                turtle conservation and marine ecosystem protection in the Gulf
                of Mexico.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-xl shadow-md">
                ...
                <p className="text-gray-600 mb-4">
                  The world&apos;s largest sea turtle facility, located right
                  here on South Padre Island, dedicated to rescue,
              ...
              <div className="bg-white p-8 rounded-xl shadow-md">
                ...
                <p className="text-gray-600 mb-4">
                  Working to advance the conservation of our coastal marine
                  resources through habitat protection, water quality
                  improvement, and marine life conservation.
                </p>
                <div className="text-ocean-500 font-semibold">
                  Gulf Coast Region
                </div>
        ...
        <section className="text-center">
          <div className="bg-gradient-to-r from-ocean-500 to-ocean-600 rounded-3xl p-12 text-white">
            ...
            <p className="text-ocean-100 text-lg mb-8 max-w-2xl mx-auto">
              Every purchase helps protect the sea turtles we love. Shop our
              ocean-inspired collection and make a difference for marine
              conservation today.
            </p>
