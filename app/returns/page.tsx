    ...
    <div className="min-h-screen bg-ocean-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          {/* How to Return */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-ocean-900 mb-6">How to Start a Return</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="w-16 h-16 bg-ocean-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl font-bold text-ocean-600">1</span>
                </div>
                <h3 className="text-lg font-semibold text-ocean-900 mb-2">Contact Us</h3>
                <p className="text-ocean-600 text-sm">Email us with your order number and reason for return</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-ocean-100 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-ocean-900 mb-2">Ship Back</h3>
                <p className="text-ocean-600 text-sm">Pack securely and ship using the provided label</p>
              </div>
            </div>
          </section>
          ...
          <section className="text-center">
            <h2 className="text-2xl font-bold text-ocean-900 mb-4">Need Help with a Return?</h2>
