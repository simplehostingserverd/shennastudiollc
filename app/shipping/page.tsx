      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-ocean-900 mb-6">Shipping Methods</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="border border-ocean-200 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-ocean-900 mb-3">Standard Shipping</h3>
                <p className="text-ocean-600 mb-3">5-7 business days</p>
                <p className="text-2xl font-bold text-ocean-900 mb-3">$5.99</p>
                <p className="text-sm text-ocean-500">Free on orders over $75</p>
              </div>
              <div className="border border-ocean-200 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-ocean-900 mb-3">Express Shipping</h3>
                <p className="text-ocean-600 mb-3">2-3 business days</p>
                <p className="text-2xl font-bold text-ocean-900 mb-3">$12.99</p>
                <p className="text-sm text-ocean-500">Available for all orders</p>
              </div>
            </div>
          </section>
          ...
          {/* Processing Time */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-ocean-900 mb-6">Processing Time</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-ocean-900 mb-6">International Shipping</h2>
            <p className="text-ocean-700 mb-4">
              We currently ship to select international destinations. Shipping costs and delivery times vary by location.
            </p>
            <p className="text-ocean-600">
              International customers are responsible for any customs duties or taxes that may apply.
            </p>
          </section>

          {/* Contact */}
          <section className="text-center">
            <h2 className="text-2xl font-bold text-ocean-900 mb-4">Questions About Your Order?</h2>
