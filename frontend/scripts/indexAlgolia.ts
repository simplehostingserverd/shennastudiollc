...
const fetchMedusaProducts = async (): Promise<MedusaProduct[]> => {
  try {
    ...
    const sampleProducts: MedusaProduct[] = [
      {
        ...
        description:
          'Beautiful ceramic mug featuring a majestic sea turtle design. Perfect for your morning coffee while supporting ocean conservation.',
        ...
        tags: [
          { id: 'tag_turtle', value: 'turtle' },
          { id: 'tag_ocean', value: 'ocean' },
        ],
      ...
      },
      {
        ...
        description:
          'Elegant necklace inspired by beautiful coral formations. A stunning piece that celebrates marine biodiversity.',
        ...
        tags: [
          { id: 'tag_coral', value: 'coral' },
          { id: 'tag_jewelry', value: 'jewelry' },
        ],
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString(),
      },
      {
        ...
        description:
          'Delicate necklace featuring authentic ocean shells. Each piece is unique, just like the treasures found on the beach.',
        ...
        categories: [{ id: 'cat_jewelry', name: 'Jewelry' }],
        tags: [
          { id: 'tag_shell', value: 'shell' },
          { id: 'tag_natural', value: 'natural' },
        ],
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString(),
      },
      {
        ...
        description:
          'Inspiring poster featuring ocean conservation messaging and beautiful marine life artwork. Perfect for any space.',
        ...
        tags: [
          { id: 'tag_conservation', value: 'conservation' },
          { id: 'tag_art', value: 'art' },
        ],
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString(),
      },
    ...
    console.log(
      `✅ Created ${sampleProducts.length} sample products for indexing`
    )
