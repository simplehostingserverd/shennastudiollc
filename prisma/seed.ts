  ...
  const products = await prisma.product.createMany({
    data: [
      ...
      },
      {
        ...
        price: 2999,
        imageUrl:
          'https://res.cloudinary.com/demo/image/upload/shell-necklace.jpg',
      },
      {
        ...
        price: 2499,
        imageUrl:
          'https://res.cloudinary.com/demo/image/upload/ocean-wave-poster.jpg',
      },
      {
        ...
        price: 1599,
        imageUrl:
          'https://res.cloudinary.com/demo/image/upload/starfish-earrings.jpg',
      },
    ],
  })
