        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-display font-bold">Ocean Store</span>
            </div>
            <p className="text-ocean-100 max-w-md mb-6">
              Bringing the beauty and wonder of the ocean to your everyday life through 
      ...
      <div className="bg-ocean-900 border-t border-ocean-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm text-ocean-200">
            <p>© {new Date().getFullYear()} Ocean Store. All rights reserved.</p>
